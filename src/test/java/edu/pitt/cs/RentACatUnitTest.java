...
public class RentACatUnitTest {
	 ...
	 * @throws IllegalAccessException 
		...
		// TODO: Fill in
		Class<?> rentClass=r.getClass();
		Method m=rentClass.getDeclaredMethod("getCat",int.class);
		m.setAccessible(true);
		Object rent=m.invoke(r,2);
		assertNull(rent);
		//test the out put
		String outpString="Invalid cat ID." + newline;
		assertEquals(outpString,out.toString());
	}
	 ...
	 * the class object of r instead of hardcoding it as RentACatImpl.
		...
		assertNotNull(rent);
		//test the out put
		System.out.println("cat has an ID of 2");
		assertEquals("cat has an ID of 2",out.toString().trim());
	}
	...
	public void testRentCatNumCats3() {
		...
		String outpString="Old Deuteronomy has been rented." + newline;
		assertEquals(outpString,out.toString());
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		String outpString="Sorry, Old Deuteronomy is not here!" + newline;
		assertEquals(outpString,out.toString());
	}
	...
	public void testReturnCatNumCats3() {
		...
		String outpString="Welcome back, Old Deuteronomy!" + newline;
		assertEquals(outpString,out.toString());
	}
	...
	public void testReturnFailureCatNumCats3() {
		...
		String outpString="Old Deuteronomy is already here!" + newline;
		assertEquals(outpString,out.toString());
	}
